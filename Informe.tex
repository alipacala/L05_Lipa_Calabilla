...
\chead{\hspace{1cm}\vspace{0.2cm}Laboratorio 05 - Elaboración de reportes operacionales}
\rhead{}
...
\begin{document}
    ...
    \begin{enumerate}[\tab 1.]
        ...
        \begin{itemize}
            ...
            \begin{center}
                \includegraphics[width=5cm]{./img/img1.3.png}
            \end{center}
        ...
        \begin{itemize}
            ...
            Para agregar los datos usar el siguiente codigo:
            \begin{center}
                \includegraphics[width=10cm]{./img/img5.1.png}
            \end{center}
    ...
    \begin{enumerate}[\tab 1.]
        ...
        El codigo seria:
        \begin{center}
            \includegraphics[width=10cm]{./img/img11.1.png}
        \end{center}
        El resultado seria:
        \begin{center}
        ...
        El resultado seria:
        \begin{center}
            \includegraphics[width=5cm]{./img/img12.2.png}
        \end{center}
    \end{enumerate}
